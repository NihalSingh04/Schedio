...
//   if (isBreak) {
//     return (
//       <div className="h-full rounded-xl border border-dashed border-slate-200 bg-slate-50 p-2 text-center text-xs text-slate-500">
//         Break
//       </div>
//     );
//   }
...
//   if (!entry) {
//     return <div className="h-full rounded-xl border border-slate-100 bg-white p-2" />;
//   }
...
//             }}
//           >
//             <div className="sticky left-0 z-10 rounded-xl bg-white p-2 text-xs font-semibold text-slate-700 border border-slate-200">
//               Day / Slot
//             </div>

//             {Array.from({ length: periodsPerDay }, (_, i) => i + 1).map((slot) => (
//               <div key={slot} className="rounded-xl bg-white p-2 text-xs font-semibold text-slate-700 border border-slate-200 text-center">
//                 P{slot}
//               </div>
//             ))}
...
//                 <div className="sticky left-0 z-10 rounded-xl bg-white p-2 text-sm font-semibold border border-slate-200">
//                   {day}
//                 </div>
